...
public class ScrollFixLayoutAdapter extends DelegateAdapter.Adapter{
    private Context context;
    private LayoutHelper layoutHelper;
    private LayoutInflater layoutInflater;
    private String name;
    public ScrollFixLayoutAdapter(Context context, LayoutHelper layoutHelper, String name){
