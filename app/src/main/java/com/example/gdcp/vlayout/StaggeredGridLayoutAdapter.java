...
public class StaggeredGridLayoutAdapter extends DelegateAdapter.Adapter{
    private Context context;
    private LayoutHelper layoutHelper;
    private LayoutInflater layoutInflater;
    private String name;
    public StaggeredGridLayoutAdapter(Context context, LayoutHelper layoutHelper, String name){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ViewGroup.LayoutParams layoutParams = ((MyViewHolder) holder).name.getLayoutParams();
        layoutParams.height = 260 + position % 7 * 20;
        ((MyViewHolder) holder).name.setLayoutParams(layoutParams);
